...
func (r *FileOutageRepository) Load() ([]*outage.Outage, error) {
	...
	outages := make([]*outage.Outage, 0, len(records))
...
func (r *FileOutageRepository) Save(outages []*outage.Outage) error {
