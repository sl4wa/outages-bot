...
func (m *mockOutageProviderForOutages) FetchOutages(_ context.Context) ([]outage.RawOutage, error) {
...
func TestRunOutagesCommand_Empty(t *testing.T) {
	provider := &mockOutageProviderForOutages{outages: []outage.RawOutage{}}
